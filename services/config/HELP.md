...
* The following dependencies are not known to work with Spring Native: 'Cloud Bootstrap, Cloud Bus, Spring Configuration Processor'. As a result, your application may not work as expected.
...
```
$ docker run --rm config:0.0.1-SNAPSHOT
```
