...
* The following dependencies are not known to work with Spring Native: 'Cloud Bootstrap, Cloud Bus, Spring Configuration Processor, Spring Boot DevTools, Gateway'. As a result, your application may not work as expected.
